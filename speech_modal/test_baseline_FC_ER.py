...
from finetune_network import baseline_FC_ER
...
model = baseline_FC_ER()
model.load_state_dict(torch.load('/server18/wb/Age_Work_Summary/Multimodal_Age_Estimation_2/github/speech_modal/saved_models/baseline_FC_ER.pt'))# baseline_FC_ER
