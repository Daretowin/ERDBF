...
class MyDatasets(object):
    ...
    def splits(self):
        self.dataSets[0]['data0'] = np.load('/server18/wb/agevoxceleb/multimodal_embedding/best_image_emb/SC/train_final_emb.npy',allow_pickle=True)
        self.dataSets[0]['data1'] = np.load('/server18/wb/agevoxceleb/multimodal_embedding/audio_emb/SC/train_em.npy',allow_pickle=True)
        ...
        self.dataSets[1]['data0'] = np.load('/server18/wb/agevoxceleb/multimodal_embedding/best_image_emb/SC/dev_final_emb.npy',allow_pickle=True)
        self.dataSets[1]['data1'] = np.load('/server18/wb/agevoxceleb/multimodal_embedding/audio_emb/SC/dev_em.npy',allow_pickle=True)
        ...
        self.dataSets[2]['data0'] = np.load('/server18/wb/agevoxceleb/multimodal_embedding/best_image_emb/SC/test_final_emb.npy',allow_pickle=True)
        self.dataSets[2]['data1'] = np.load('/server18/wb/agevoxceleb/multimodal_embedding/audio_emb/SC/test_em.npy',allow_pickle=True)
