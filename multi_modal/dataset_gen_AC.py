...
if __name__ == "__main__":
    ...
    # model = Net1_AC(resnet)
    # model.load_state_dict(torch.load('/home/great72/great72/work/Multimodal_Age_Estimation/E-Fusion/image_modal/saved_models/AC0001_best.pt'))
    # model = model.cuda()
    # model.eval()
    # imageout_train = []
    # imageout_dev = []
    ...
    # np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/train_emb.npy',imageout_train)
    ...
    # np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/dev_emb.npy',imageout_dev)
    ...
    # np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/test_emb.npy',imageout_test)

    # ---- image 向量三张取平均
    train_3 = np.load('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/train_emb.npy',allow_pickle=True)
    dev_3 = np.load('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/dev_emb.npy',allow_pickle=True)
    test_3 = np.load('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/test_emb.npy',allow_pickle=True)
    train_1 = []
    dev_1 = []
    test_1 = []
    ...
    np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/train_final_emb.npy',train_1)
    np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/dev_final_emb.npy',dev_1)
    np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/best_image_emb/AC/test_final_emb.npy',test_1)
    ...
    # model = Net2_AC()
    # model.load_state_dict(torch.load('/home/great72/great72/work/Multimodal_Age_Estimation/E-Fusion/audio_modal/saved_models/AC_best.pt'))
    # model.cuda()
    # model.eval()
    ...
    # np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/audio_emb/AC/train_em.npy',trem)
    ...
    # np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/audio_emb/AC/dev_em.npy',dvem)
    ...
    # np.save('/mnt3/wb/agevoxceleb/multimodal_embedding/audio_emb/AC/test_em.npy',tsem)
