...
from fusion_network import ERDBF  as ERDBF
...
model = ERDBF()
model.load_state_dict(torch.load('/server18/wb/Age_Work_Summary/Multimodal_Age_Estimation_2/github/multi_modal/saved_models/ERDBF_best.pt'))
