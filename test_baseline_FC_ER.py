...
model = baseline_FC_ER(resnet)

if FLAGS.use_bestModel:
    model.load_state_dict(torch.load('/server18/wb/Age_Work_Summary/Multimodal_Age_Estimation_2/github/face_modal/saved_models/baseline_FC_ER.pt'))
if cuda:
    model = model.cuda()
